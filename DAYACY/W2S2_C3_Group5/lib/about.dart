  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        ...
        body: ListView(children: <Widget>[
          ...
          ConstrainedBox(
              constraints: BoxConstraints.expand(width: 100, height: 200),
              child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed rutrum quis dui at fringilla. Aenean malesuada congue felis vel dictum. Donec iaculis purus felis, nec semper diam volutpat sed.")),
          SizedBox(
            width: 100,
            height: 50,
          )
